...
def _get_branding_settings(chat_settings):
    ...
    return {
        ...
        "bubble_color": getattr(chat_settings, 'bubble_color', '') or "",
        "badge_color": getattr(chat_settings, 'badge_color', '') or "",
        "send_button_color": getattr(chat_settings, 'send_button_color', '') or "",
